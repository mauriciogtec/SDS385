...
$$
this will make all columns centered (zero mean) and scaled (standard deviation one). This helps a lot to improve the performance of algorithms since the resultant likelihood is better behaved. This might not be necessary for more advanced optimization methods, such as Newthon's method, but is is necessary for gradient descent.
